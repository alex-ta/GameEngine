...
public class FreeLook extends GameComponent{
	...
	{
		getTransform().rotate(yAxis, (float) Math.toRadians(-MouseW.getDeltaMovement().y * sensitivity));
		getTransform().rotate(getTransform().getRot().getRight(), (float) Math.toRadians(MouseW.getDeltaMovement().x * sensitivity));
